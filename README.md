...
<details>
  ...
  - Se devi trasferire i tuoi dati a questa nuova versione dell'app, basta copiare i file `server_data.json` e `last_id.txt` dalla cartella della vecchia versione alla cartella `data` della nuova versione. Se non vuoi ricreare ogni volta l'ambiente virtuale di Python puoi anche spostare la cartella `.egovenv` nella nuova installazione.
